...
@endphp
                ...
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="key" class="form-control form-control-lg form-control-a" required placeholder="">
                        </div>
                    </div>
    ...
    <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
        ...
        <span></span>
            ...
            <a class="navbar-brand text-brand" href="{{route('home')}}">عقارات <span class="color-b"> السعودية </span></a>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="{{route('showAllReales',$category->slug)}}" class="dropdown-item" > {{$category->category}} </a>
            ...
            <button type="button" style="background: #5393eb ;" class="rounded-3 mx-2 btn btn-b-n navbar-toggle-box navbar-toggle-box-collapse" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo01">
        <i class="bi bi-search"></i>
      </button>
      <a href="{{route('real.add')}}" type="button" style="background: #5393eb ; border: none;   display: inline-block; color:white;  padding: 19px 32px;   font-size: 26px; text-align: center;" class="rounded-3 mx-2 btn btn-b-n navbar-toggle-box navbar-toggle-box-collapse" >
        اضافة عقار
      </a>
        </div>
    </nav>
