                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <div class="title-single-box">
                            ...
                            <span class="color-text-a">تواصل معنا وسنعمل على الرد بأقرب فرصة</span>
                        </div>
                    </div>
                                ...
                                <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <input type="text" name="name" class="form-control form-control-lg form-control-a" placeholder="الاسم " required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                ...
                                <div class="icon-box">
                                    ...
                                    <div class="icon-box-content table-cell">
                                        <div class="icon-box-title">
                                            <h4 class="icon-title">وسائل التواصل الاجتماعية </h4>
                                        </div>
